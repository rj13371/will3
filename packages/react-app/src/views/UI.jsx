...
import { Address, Balance, Events, AssetSelector, HowItWorks } from "../components";
...
export default function UI({
  ...
  const titleImage = "./../assets/will3.jpg";
  ...
  return (
    <div>
      ...
      */}
      <div style={{ padding: 16, width: "80%", margin: "auto", marginTop: 24, paddingBottom: 100 }}>
        <img src={titleImage} />
